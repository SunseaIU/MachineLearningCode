...
class Softmax:
    ...
    def train(self, digits, labels, maxIter = 100, alpha = 0.1):  #梯度下降法更新参数
...
if __name__ == '__main__':
    softmax = Softmax()
    trainDigits, trainLabels = softmax.loadData('softmax/dataset/trainingDigits')
    testDigits, testLabels = softmax.loadData('softmax/dataset/testDigits')
